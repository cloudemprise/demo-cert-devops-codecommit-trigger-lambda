...
# demo-cert-devops-codecommit-trigger-lambda-sync-git-repos.sh
...
PROJECT_NAME="demo-cert-devops-codecommit-trigger-lambda"
while true
do
  # -e : stdin from terminal
  # -r : backslash not an escape character
...
REPO_DESCRIPTION=\
"AWS Lambda functions that respond to an AWS CodeCommit repository trigger. \
Returns the URL used for cloning the associated repository to an Amazon \
CloudWatch Log Group log event."
while true
do
  # -e : stdin from terminal
  # -r : backslash not an escape character
